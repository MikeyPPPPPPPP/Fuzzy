...
def getArgs():
    ...
    filter.add_argument('-re', help="cheeck the page with a regex", required=False)
    ...
    tunning.add_argument('-ssl', help="set SSL verify (default False) GET POST INFO etc ", action='store_true', required=False)
    tunning.add_argument('--userAgentTumbler', help="file of useragent", required=False)
